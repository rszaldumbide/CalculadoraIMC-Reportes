<?php 
    $id=$datos[0]['u_id'];
    $nombre=$datos[0]['u_nombre'];
    $apellido=$datos[0]['u_apellido'];
    $cedula=$datos[0]['u_cedula'];
    $genero=$datos[0]['u_genero'];
    $edad=$datos[0]['u_edad'];
    $valorimc=$datos[0]['u_valorimc'];
    $rangoimc=$datos[0]['u_rangoimc'];
    $estado=$datos[0]['u_estado'];
?>
...
<body data-spy="scroll" data-target=".navbar" data-offset="40">
    ...
    <section class="section" style="background:white;">
                        ...
                        <div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <button id="busqueda" href="<?php echo base_url('/obtenerNombre/'.'#txtDatos')?> "class="btn btn-dark" type="submit">🔍</button>
                                </div>
                            </div>
                        </div>
                    </span>
        ...
        <div class="container" id="datosActualizarPaciente">
            <div class="row text-center">
                <div class="col-lg-1"></div>
                <div class="col-lg-10">
                    <span href="" class="card border-0 text-dark p-3 " style="background:#F1FAFB;">
                        <h6 style="font-size: x-large;">Actualizar campos del Paciente</h6>
                        <form action="<?php echo base_url('/index.php/actualizarPaciente') ?>" method="POST">
                            <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">Numero:</span>
                                    </div>
                                    <input type='text' required disabled class='form-control' id='pac_id' name='pac_id' value="<?php echo $id?>">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">Cedula:</span>
                                    </div>
                                    <input type="text" required id="pac_ced" name="pac_ced" class="form-control" value="<?php echo $cedula?>">
                                </div>    
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">Nombre:</span>
                                    </div>
                                    <input type='text' required class='form-control' id='pac_nombre' name='pac_nombre' value="<?php echo $nombre?>">
                                </div>
                                <div class=" input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">Apellido:</span>
                                    </div>
                                    <input type="text" required class="form-control" id="pac_ape" name="pac_ape" value="<?php echo $apellido?>">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="number" required class="form-control" id="pac_edad" name="pac_edad" value="<?php echo $edad?>">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" required id="pac_valorimc" name="pac_valorimc" value="<?php echo $valorimc?>">
                                </div>
